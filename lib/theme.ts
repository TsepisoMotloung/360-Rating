...
export const buttonClasses = {
  ...
  secondary: `${THEME.gray.bg} border ${THEME.gray.border} text-gray-700 py-2 px-4 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors`,
...
export const alertClasses = {
  ...
  info: `${THEME.primary.bgLight} border ${THEME.primary.border} text-blue-800`,
};
